...
public class EulerCycle {
    ...
    public static void main(String... arg) {
        ...
        try {
            ...
            System.out.println("the euler path or euler cycle is ");
            // print euler path or cycle
            EulerCycle cycle = new EulerCycle(number_of_nodes, adjacency_matrix);
            cycle.printEulerTour();
